...
# बदलना हो तो नीचे DIT_GGUF_NAME बदलें (या environment variable LTX_DIT_GGUF सेट करें)।
DIT_GGUF_NAME = os.environ.get("LTX_DIT_GGUF", "ltx-2-3-22b-dev-Q4_K_M.gguf")
_DIT_GGUF_URL = "https://huggingface.co/vantagewithai/LTX-2.3-GGUF/resolve/main/dev/" + DIT_GGUF_NAME
...
# 🇮🇳 22B DiT model download (quant DIT_GGUF_NAME से चुना जाता है)।
download_file(_DIT_GGUF_URL, os.path.join(MODELS_DIR, "unet"), filename=DIT_GGUF_NAME)
